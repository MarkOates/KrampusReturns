...
void Runner::initialize()
{
   ...
   achievements.set_achievements({
      { "blobs_done",
         new AllegroFlare::Achievement("Unblobbed", "Clear out all the blobs in Level 1" ),
         false,
         false,
      },
      { "skeletons_done",
         new AllegroFlare::Achievement("No more bones", "Clear out all the skeletons in Level 2" ),
         false,
         false,
      },
